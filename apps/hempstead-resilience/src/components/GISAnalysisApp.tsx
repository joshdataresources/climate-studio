...
const DEFAULT_VIEWPORT: ViewportState = {
  center: { lat: 40.5887, lng: -73.6577 }, // Long Beach, NY 11566
  zoom: 12.0, // Focused on Long Beach and surrounding south shore
}

const DEFAULT_SAVED_VIEW: SavedView = {
  id: 'nassau-south-shore',
  name: 'Nassau South Shore',
