...
function MenuItem({ icon, label, isActive, onClick }: MenuItemProps) {
  return (
    <button
      onClick={onClick}
      className={`flex flex-col gap-[4px] items-center justify-center px-[5px] py-[10px] relative rounded-[8px] shrink-0 transition-colors ${
        isActive 
...
export default function Sidebar() {
  ...
  const { viewEnabled, toggleView } = useSidebar()
  ...
  return (
    <div className="fixed left-0 top-0 bottom-0 z-[1000] backdrop-blur-[6px] backdrop-filter bg-[rgba(255,255,255,0.45)] rounded-br-[12px] rounded-tr-[12px] w-[76px]">
      <div className="flex flex-col gap-[8px] isolate items-center overflow-clip p-[8px] relative rounded-[inherit] h-full">
        {/* Logo */}
        <div className="flex flex-col gap-[8px] items-center relative shrink-0">
          <div className="h-[59px] relative shrink-0 w-[57px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57 59">
              <rect fill="white" height="59" rx="8" width="57" />
          ...
          <div className="h-px relative shrink-0 w-full">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60 1">
              <path d="M60 0V1H0V0H60Z" fill="#D7D7D7" fillOpacity="0.45" />
            </svg>
          </div>
        ...
        {/* View toggle - independent on/off */}
        <ToggleItem
          icon={SVG_PATHS.view}
          label="View"
          isActive={viewEnabled}
          onClick={toggleView}
        />
      ...
      <div 
        aria-hidden="true" 
        className="absolute border-[1px_1px_1px_0px] border-[rgba(255,255,255,0.5)] border-solid inset-0 pointer-events-none rounded-br-[12px] rounded-tr-[12px] shadow-[0px_4px_25px_0px_rgba(0,0,0,0.1)]" 
      />
    </div>
  )
}
